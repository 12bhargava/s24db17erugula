...
router.get('/', function (req, res) {
  res.render('index', { title: 'racquet App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'racquet App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'racquet App Login', user: req.user });
});
